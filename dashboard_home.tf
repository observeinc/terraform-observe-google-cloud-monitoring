# terraform import observe_dashboard.app_home 41214248
resource "observe_dashboard" "app_home" {
  description = "App Home Dashboard"
  layout = jsonencode(
    {
      autoPack = true
      gridLayout = {
            ...
            items = [
              ...
              },
              {
                card = {
                  cardType = "text"
                  id       = "card-vg4gqfkn"
                  text     = local.inventory_description
                  title    = "Untitled Text"
                }
                layout = {
                  h           = 10
      ...
      stageListLayout = {
        ...
        selectedStageId = "stage-rcjq4hxw"
        timeRange = {
          display               = "Today 12:19:51 → 13:19:51"
          endTime               = null
    ...
    [
      {
        ...
        layout = {
          ...
          steps = [
            {
              customName    = "Input"
              customSummary = "Projects Collection Enabled"
              datasetQuery  = null
              datasetQueryId = {
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "Resources Asset Inventory"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "Compute Instance"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
            ...
            },
            {
              ...
              opal = [
                "exists project_id = @projects.project_id",
                "follow computeInstanceAssetKey = @\"Compute Metrics\".computeInstanceAssetKey",
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "Cloud Functions Metrics"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "Cloud Functions Instances"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "PubSub Service Quota Metrics"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "Cloud SQL Instance"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
          ...
          steps = [
            {
              ...
              customName    = "Input"
              customSummary = "Cloud Scheduler Jobs"
              datasetQuery  = null
              datasetQueryId = {
                ignoreCompress = false
                queryId        = null
