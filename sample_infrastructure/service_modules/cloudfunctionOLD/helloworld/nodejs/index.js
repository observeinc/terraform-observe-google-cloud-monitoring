...
// curl -X POST -d '{"errorName": "helloError2"}' -H 'Content-Type: application/json' https://us-west1-content-testpproj-stage-1.cloudfunctions.net/test-stg-0-function-optional-error
functions.http('helloHttp', (req, res) => {

    if (req.body.hasOwnProperty('errorName')) {
        const { errorName } = req.body

        console.log(`${errorName} called`);
        if (errorName == "helloError2") {
            this.helloError2()
        }
        res.send(`${errorName} Error Created'!`);
    } else {
