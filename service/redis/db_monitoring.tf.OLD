...
# terraform import observe_dashboard.redis_monitoring 41726051
  ...
  layout = jsonencode(
    {
      ...
      stageListLayout = {
        ...
        selectedStageId = "stage-9y2jp9iw"
        timeRange = {
          ...
          steps = [
            ...
            },
            {
                    ...
                    expressions = [
                      {
                        ...
                        summaryMode    = "over-time"
                        type           = "metricExpression"
                        valueColumnId  = "metric_stats_memory_usage_ratio_44v2388h"
                      },
                    ]
                    selectedExpressionId = "metricExpression-oynzpjwq"
                  }
                }
                summary = null
                type    = "ExpressionBuilder"
              ...
              opal = [
                ...
                "aggregate metric_stats_memory_usage_ratio_44v2388h:sum(metric_stats_memory_usage_ratio_44v2388h), group_by(hostname)",
              ]
              queryPresentation = {}
              type              = "unknown"
            },
        ...
        input = [
          {
            datasetId   = "${local.redis_metrics}"
            datasetPath = null
            inputName   = "keyspace_keys_with_expiration_from_Redis/Metrics"
            inputRole   = "Data"
            stageId     = null
          },
        ]
