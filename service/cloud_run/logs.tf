resource "observe_dataset" "cloudrun_logs" {
  workspace   = local.datasets.cloudrun_logs.workspace
  name        = local.datasets.cloudrun_logs.name
  freshness   = local.datasets.cloudrun_logs.freshness
  description = local.datasets.cloudrun_logs.description
