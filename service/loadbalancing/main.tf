...
*/
  ...
  datasets = {
    load_balancing_metrics = {
      ...
      freshness   = lookup(local.freshness, "load_balancing_metrics", var.freshness_default_duration)
    ...
    load_balancing_logs = {
      ...
      freshness   = lookup(local.freshness, "load_balancing_logs", var.freshness_default_duration)
    ...
    health_check_logs = {
      ...
      freshness   = lookup(local.freshness, "health_check_logs", var.freshness_default_duration)
      description = "This dataset contains health check logs generated for load balancers"
    }

    load_balancing_config_audit_logs = {
      workspace   = local.workspace
      name        = format(var.name_format, "Config Audit Logs")
      freshness   = lookup(local.freshness, "load_balancing_config_audit_logs", var.freshness_default_duration)
...
resource "observe_dataset" "url_map" {
  ...
  freshness   = lookup(var.freshness_overrides, "url_map", var.freshness_default_duration)
...
resource "observe_dataset" "backend" {
  ...
  freshness   = lookup(var.freshness_overrides, "backend", var.freshness_default_duration)
...
resource "observe_dataset" "forwarding_rule" {
  ...
  freshness   = lookup(var.freshness_overrides, "forwarding_rule", var.freshness_default_duration)
...
resource "observe_dataset" "load_balancing_health_check" {
  ...
  freshness   = lookup(var.freshness_overrides, "health_check", var.freshness_default_duration)
...
resource "observe_dataset" "load_balancing_load_balancer" {
  ...
  freshness   = lookup(var.freshness_overrides, "load_balancing_load_balancer", var.freshness_default_duration)
